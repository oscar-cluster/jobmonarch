<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><!-- Begin footer.tpl -->
</form> <!-- ganglia-form -->
</div> <!-- tabs-main -->
...
Ganglia Web Frontend version <?php echo $this->scope["webfrontend_version"];?>

<a href="http://ganglia.sourceforge.net/downloads.php?component=ganglia-webfrontend&amp;version=<?php echo $this->scope["webfrontend_version"];?>">Check for Updates.</a><br />

Ganglia Web Backend <i>(<?php echo $this->scope["webbackend_component"];?>)</i> version <?php echo $this->scope["webbackend_version"];?>

<a href="http://ganglia.sourceforge.net/downloads.php?component=<?php echo $this->scope["webbackend_component"];?>&amp;version=<?php echo $this->scope["webbackend_version"];?>">Check for Updates.</a><br />

Downloading and parsing ganglia's XML tree took <?php echo $this->scope["parsetime"];?>.<br />
Images created with <a href="http://www.rrdtool.org/">RRDtool</a> version <?php echo $this->scope["rrdtool_version"];?>.<br />
<?php echo $this->globals["ad"];?> <?php echo $this->globals["version"];?>.<br />
</font>
</div>
</div> <!-- div-tabs -->
</BODY>
