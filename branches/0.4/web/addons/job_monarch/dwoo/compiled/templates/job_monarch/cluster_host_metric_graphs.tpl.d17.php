...
<tr>
<?php 
$_fh0_data = (isset($this->scope["sorted_list"]) ? $this->scope["sorted_list"] : null);
if ($this->isTraversable($_fh0_data) == true)
{
	foreach ($_fh0_data as $this->scope['host'])
	{
...
<?php 
$_fh1_data = (isset($this->scope["overflow_list"]) ? $this->scope["overflow_list"] : null);
if ($this->isTraversable($_fh1_data) == true)
{
	foreach ($_fh1_data as $this->scope['host'])
	{
/* -- foreach start output */
?>
<?php echo $this->scope["host"]["metric_image"];
