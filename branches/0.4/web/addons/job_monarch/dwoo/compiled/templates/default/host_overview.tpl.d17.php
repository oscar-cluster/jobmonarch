...
<?php 
$_fh2_data = (isset($this->scope["s_metrics_data"]) ? $this->scope["s_metrics_data"] : null);
if ($this->isTraversable($_fh2_data) == true)
{
	foreach ($_fh2_data as $this->scope['s_metric'])
	{
...
<?php 
$_fh3_data = (isset($this->scope["c_metrics_data"]) ? $this->scope["c_metrics_data"] : null);
if ($this->isTraversable($_fh3_data) == true)
{
	foreach ($_fh3_data as $this->scope['c_metric'])
	{
/* -- foreach start output */
?>
<tr>
